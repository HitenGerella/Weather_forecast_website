...
const mainPage = document.querySelector('.site-content')
...
function processFirstDay(data){
    ...
    //as the API is giving speed in m/sec, but we want to show km/hr. we need to multiply by 3.6
